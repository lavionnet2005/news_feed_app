...
public final class QueryUtils {
    ...
    public static ArrayList<News> fetchData(String requrl){
        ...
        ArrayList<News> publishList = extractList(jsonResponse);
    ...
    public static ArrayList<News> extractList(String json) {
        ...
        ArrayList<News> newsFeedList = new ArrayList<>();
        ...
        try {
            ...
            JSONObject responseArrray =  list.getJSONObject("response");

            JSONArray resultsArray = responseArrray.getJSONArray("results");
            ...
            for(int i=0; i<resultsArray.length(); i++){
                ...
                newsFeedList.add(new News(title,url));
            }
